...
public class UhEDocLiteDatabasePostProcessor
extends EDocLitePostProcessor
{

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(UhEDocLiteDatabasePostProcessor.class);
    ...
    throws RemoteException
    {
        ...
        // RRG Save when document goes final
        if (event.getNewRouteStatus() ==  KewApiConstants.ROUTE_HEADER_PROCESSED_CD) {
    ...
    throws RemoteException
    {
        ...
        /* RRG Remove persist on save, lets only save on final
    ...
    throws RemoteException
    {
        ...
        /* RRG don't want to save on route level change either....only final status
    ...
    {
        try {
            org.kuali.rice.kew.api.document.Document document = KewApiServiceLocator.getWorkflowDocumentService().getDocument(
            documentId);
