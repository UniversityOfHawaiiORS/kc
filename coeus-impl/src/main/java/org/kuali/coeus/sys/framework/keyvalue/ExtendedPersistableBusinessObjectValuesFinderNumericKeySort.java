 ...
 * </p>
 */
public class ExtendedPersistableBusinessObjectValuesFinderNumericKeySort extends PersistableBusinessObjectValuesFinder {
    ...
    {    
        ...
        {    
            try
            {
                Integer desc1 = Integer.valueOf(((KeyValue)kv1).getKey().toString());
                Integer desc2 = Integer.valueOf(((KeyValue)kv2).getKey().toString());
