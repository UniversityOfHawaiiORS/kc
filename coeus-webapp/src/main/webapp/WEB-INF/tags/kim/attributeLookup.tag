...
<%--UH KC-541 code added by rbl to pre-populate new "Unit Search" input field with unit number upon Unit lookup initiation from Person(IDM) edit screen --%>
<c:set var="params" value="${fn:replace(params,'unitNumber','unitSearchInput')}" />
