...
VALUES ('KC-GEN','All','uh_pd_key_person_certification_must_be_yes_question_ids',sys_guid(),1,'CONFG',
        '298280:80',
        'Comma separated list of question:displayLength pairs whose question must be answered with "Yes" to submit the proposal, id must match question_ref_id from the question table. Error message will display portion of question starting with displayLenght chars',
        'A','KC');
